...
public class ScoreCalculator
  ...
  Object2LongMap<Vehicle> loadHardScores;
  ...
  public void resetWorkingSolution(
    ...
    loadHardScores = new Object2LongOpenHashMap<>();
    ...
    loads = new Object2LongOpenHashMap<>(size);
...
//     System.out.println("update, " + firstDiff);
    ...
    hardScore -= loadHardScores.getLong(v);

    long routeHardScore = 0L;
    long loadHardScore = 0L;
...
//    if(routeHardScore == 0 ) {
//      boolean flag = false;
//      for (Visit visit : loads.keySet()) {
//        if(loads.get(visit)<0) {
//          System.out.println("-----printing loads------");
//          flag = true;
//          ParcelVisit parcelVisit = (ParcelVisit) visit;
//          System.out.println(parcelVisit + " " + parcelVisit.getParcel().getNeededCapacity());
//          System.out.println(loads.get(visit));
//        }
//      }
//      if(flag) {
//        System.out.println("loadHardScore " + loadHardScore);
//        System.out.println("routeHardScore " + routeHardScore);
...
//    }
  ...
  private void updateLoad(ParcelVisit pv) {
//    System.out.println("updating loads " + pv + " "+pv.getNextVisit());
    long load = 0;
